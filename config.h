...
9: mail
*/
static const char *tags[] = { "1", "🌐", "🎮", "🎧", "5", "6", "7", "8", "📨" };
...
static const char *volmutecmd[]  = { "amixer", "set", "Master", "mute" };
static const char *volunmutecmd[]  = { "amixer", "set", "Master", "unmute" };
static const char *pausemusic[]  = { "playerctl", "-a", "pause" };
static const char *playmusic[]  = { "playerctl", "-a", "play" };
static const char *playnextmusic[]  = { "playerctl", "-a", "next" };
static const char *playpreviousmusic[]  = { "playerctl", "-a", "previous" };
...
void
togglemute(const Arg *a)
{ 	
	mute = !mute;
	if (mute) {
		Arg arg = {.v = volmutecmd};
		spawn(&arg );
	} else {
		Arg arg = {.v = volunmutecmd};
		spawn(&arg );
	}
}
